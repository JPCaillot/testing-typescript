...
jest.mock("../../../app/server_app/data/DataBase", () => {
    return {
        //this way, instead of only declaring a DataBase object, the implementations will only be called when needed
        //way to inject mocks in CONSUMER CLASSES***
...
describe('UserCredentialsDataAccess test suite', () => {
    ...
    it('should add user and return the id', async () => {
        //before: mockReturnedValue
        //resolved for async, once for more safety
